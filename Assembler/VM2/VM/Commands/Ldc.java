...
/*    */ 
/*    */ public class Ldc extends Compiling.Command {
/*    */   public Ldc(String c, int i, int num) {
/*  7 */     super(c, i, num);
/*    */   }
/*    */   
...
/* 15 */     switch (prefix) {
/* 16 */     case 0:  Startcreation.frame.SetRegisterValue(2, argval);
/* 17 */       break;
/* 18 */     case 1:  Startcreation.frame.SetRegisterValue(2, arg);
/* 19 */       break;
/* 20 */     case 2:  Startcreation.frame.SetRegisterValue(2, argdog);
/* 21 */       break;
...
/* Location:              /home/artem/Downloads/VM@.jar!/Commands/Ldc.class
